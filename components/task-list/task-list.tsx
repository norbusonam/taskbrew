    ...
    <div className={props.className}>
      ...
      {props.canCreateNewTask && (
        <button
          ...
          className="flex w-full flex-row items-center gap-3 border-b-[1px] border-neutral-200 p-2 text-neutral-500 transition-colors hover:bg-neutral-100 active:bg-neutral-200 dark:border-neutral-800 dark:hover:bg-neutral-800 dark:active:bg-neutral-700"
        >
