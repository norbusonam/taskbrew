...
export function DurationButton(props: Props) {
  return (
    <Menu as="div" className="relative">
      ...
      >
        <Menu.Items className="absolute right-0 z-10 mt-1 h-44 w-32 origin-top-right overflow-scroll rounded-md bg-gray-200 p-1 shadow-xl">
          {Object.keys(DURATION_TO_TITLE)
            ...
            .map((duration) => (
              <DurationButtonMenuItem
                key={duration}
                duration={duration}
                isActive={props.duration === duration}
  ...
  return (
    <Menu.Item>
      <button
        ...
        } w-full rounded-md py-1 text-center text-sm text-gray-800 transition-colors hover:bg-gray-300 active:bg-gray-400`}
